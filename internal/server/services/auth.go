...
import (
	...
	"github.com/GTedya/gophkeeper/internal/server/config"
	"github.com/GTedya/gophkeeper/internal/server/models"
	"github.com/GTedya/gophkeeper/internal/server/storage"
	"github.com/GTedya/gophkeeper/internal/server/storage/pg"
	"github.com/GTedya/gophkeeper/pkg/hasher"
	"github.com/GTedya/gophkeeper/pkg/hasher/hmac"
	"github.com/GTedya/gophkeeper/pkg/token"
	"github.com/GTedya/gophkeeper/pkg/token/jwt"
)
...
func (srv *AuthService) VerifyToken(ctx context.Context, request *pb.VerifyTokenRequest) (*pb.VerifyTokenResponse, error) {
	...
	if err != nil {
		...
		if errors.Is(err, token2.ErrInvalidToken) {
